(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 3116, e => {
    "use strict";
    let t = (0, e.i(75254).default)("clock", [
        ["circle", {
            cx: "12",
            cy: "12",
            r: "10",
    ...
    "use strict";
    let t = (0, e.i(75254).default)("leaf", [
        ["path", {
    ...
    "use strict";
    let t = (0, e.i(75254).default)("heart", [
        ["path", {
    ...
    e.s(["packages", 0, [{
        id: "A",
        title: "Full Body Massage + Steam",
        price: 1200,
        duration: "1 Hour"
    }, {
        id: "B",
        title: "Pain Relief Therapy (Full Body + Kizhi + Steam)",
        price: 1500,
        duration: "1 Hour 15 Minutes"
    }, {
        id: "C",
        title: "Full Body Massage + Shirodhara + Steam",
        price: 2500,
        duration: "1 Hour 30 Minutes"
    }, {
        id: "D",
        title: "Full Body Massage + Body Scrub + Steam",
        price: 2e3,
        duration: "1 Hour 30 Minutes"
    }, {
        id: "E",
        title: "Full Body Massage + Kizhi + Shirodhara",
        price: 3e3,
        duration: "2 Hours"
    }]])
}, 84614, 64659, e => {
    ...
    e.s(["User", 0, a], 84614);
    let s = (0, t.default)("chevron-down", [
        ["path", {
            d: "m6 9 6 6 6-6",
            key: "qrunsl"
        }]
    ]);
    e.s(["ChevronDown", 0, s], 64659)
}, 37727, 87316, e => {
    "use strict";
    var t = e.i(75254);
    let a = (0, t.default)("x", [
    ...
    e.s(["default", 0, function({
        isOpen: e,
        onClose: m,
        preselectedTreatment: p
    }) {
        let [u, f] = (0, a.useState)({
            name: "",
            phone: "",
            service: p || "",
            date: "",
        ...
        (0, a.useEffect)(() => (document.body.style.overflow = e ? "hidden" : "", () => {
        ...
        let b = (0, a.useCallback)(e => {
            ...
            y = e => {
                e.preventDefault();
                let t = h.find(e => e.id === u.service),
                    a = t ? t.name : u.service,
                    s = `Hello Ayursreya Wellness! I'd like to book an appointment.

*Name:* ${u.name}
*Phone:* ${u.phone}
*Service:* ${a}
*Preferred Date:* ${u.date}
*Preferred Time:* ${u.time}${u.notes?`
*Notes:* ${u.notes}`:""}`,
                    i = `https://wa.me/${x.clinic.whatsapp}?text=${encodeURIComponent(s)}`;
                window.open(i, "_blank"), m()
            },
            j = 1 === g ? u.name && u.phone : u.service && u.date && u.time,
            N = h.reduce((e, t) => (e[t.category] || (e[t.category] = []), e[t.category].push(t), e), {});
        return (0, t.jsx)(i.AnimatePresence, {
            children: e && (0, t.jsxs)(s.motion.div, {
                initial: {
                    opacity: 0
                },
                animate: {
                ...
                children: [(0, t.jsx)("div", {
                    ...
                    children: [(0, t.jsxs)("div", {
                        className: "relative px-8 pt-8 pb-4 border-b border-[var(--brand-forest)]/10",
                        children: [(0, t.jsx)("button", {
                            ...
                            className: "font-cormorant text-2xl md:text-3xl text-[var(--brand-forest)]",
                            children: "Book Your Session"
                        }), (0, t.jsxs)("p", {
                            className: "text-xs font-space tracking-widest uppercase text-[var(--brand-earth)] mt-1",
                            children: ["Step ", g, " of 2 — ", 1 === g ? "Your Details" : "Select Service"]
                        }), (0, t.jsxs)("div", {
                            className: "flex gap-2 mt-4",
                            children: [(0, t.jsx)("div", {
                                className: `h-[2px] flex-1 rounded-full transition-colors duration-500 ${g>=1?"bg-[var(--brand-forest)]":"bg-[var(--brand-forest)]/15"}`
                            }), (0, t.jsx)("div", {
                                className: `h-[2px] flex-1 rounded-full transition-colors duration-500 ${g>=2?"bg-[var(--brand-forest)]":"bg-[var(--brand-forest)]/15"}`
                            })]
                        })]
                    }), (0, t.jsx)("form", {
                        onSubmit: y,
                        ...
                        children: (0, t.jsx)(i.AnimatePresence, {
                            mode: "wait",
                            children: 1 === g ? (0, t.jsxs)(s.motion.div, {
                                initial: {
                                    opacity: 0,
                                    x: -20
                                },
                                ...
                                children: [(0, t.jsxs)("div", {
                                    ...
                                    children: [(0, t.jsxs)("label", {
                                        className: "flex items-center gap-2 text-xs font-space tracking-widest uppercase text-[var(--text-secondary)]",
                                        children: [(0, t.jsx)(l.User, {
                                    ...
                                    children: [(0, t.jsx)("label", {
                                        className: "text-xs font-space tracking-widest uppercase text-[var(--text-secondary)]",
                                ...
                                children: [(0, t.jsxs)("div", {
                                    ...
                                    children: [(0, t.jsxs)("label", {
                                        ...
                                        children: [(0, t.jsx)("option", {
                                            value: "",
                                            children: "Choose a treatment or package..."
                                        }), Object.entries(N).map(([e, a]) => (0, t.jsx)("optgroup", {
                                            label: e,
                                            children: a.map(e => (0, t.jsxs)("option", {
                                                value: e.id,
                                                children: [e.name, " — ₹", e.price.toLocaleString("en-IN")]
                                            }, e.id))
                                        }, e))]
                                    })]
                                }), (0, t.jsxs)("div", {
                        ...
                        className: "px-8 py-5 border-t border-[var(--brand-forest)]/10 flex items-center justify-between gap-4",
                        children: [2 === g && (0, t.jsx)("button", {
                            type: "button",
                            onClick: () => v(1),
    ...
    var v = e.i(64659);
    let b = (0, l.default)("circle-check", [
        ["circle", {
            cx: "12",
            cy: "12",
            r: "10",
    ...
    d.Heart, x.User, f.Leaf, e.s(["default", 0, function() {
        let [e, l] = (0, a.useState)(!1), [w, k] = (0, a.useState)(""), [M, S] = (0, a.useState)(null), [C, P] = (0, a.useState)(null), D = e => {
            k(e), l(!0)
        }, A = (0, a.useMemo)(() => ({
            Activity: c,
            Heart: d.Heart,
        ...
        return (0, t.jsxs)("main", {
            ...
            children: [(0, t.jsxs)("section", {
                ...
                children: [(0, t.jsx)("div", {
                    className: "absolute inset-0 bg-[var(--brand-forest)]",
                    children: (0, t.jsx)("div", {
                        className: "absolute inset-0 opacity-[0.04]",
                        children: (0, t.jsx)("div", {
                            className: "w-full h-full",
                            style: {
                                backgroundImage: "radial-gradient(circle at 30% 70%, rgba(212,200,175,0.4) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(212,200,175,0.2) 0%, transparent 40%)"
                            }
                        })
                    })
                }), (0, t.jsxs)("div", {
                    className: "relative z-10 container mx-auto px-4 sm:px-6 md:px-12 max-w-6xl pb-12 sm:pb-16 md:pb-20 pt-32 sm:pt-36 md:pt-40",
                    children: [(0, t.jsx)(s.motion.p, {
                        initial: {
                            opacity: 0,
                            y: 20
                        },
                        ...
                        children: ["Authentic therapies", (0, t.jsx)("br", {}), "for", " ", (0, t.jsx)("span", {
                            className: "font-gallient italic text-[var(--brand-sand)]",
                            children: "complete"
                        }), " ", "wellness"]
                    }), (0, t.jsx)(s.motion.p, {
                        initial: {
                        ...
                        children: "From Panchakarma detoxification to specialized therapeutic treatments — discover the full spectrum of traditional Ayurvedic healing."
                    })]
                })]
            }), (0, t.jsx)("section", {
                className: "py-16 sm:py-20 md:py-24 lg:py-36",
                children: (0, t.jsx)("div", {
                    className: "container mx-auto px-4 sm:px-6 md:px-12 max-w-6xl",
                    children: (0, t.jsxs)("div", {
                        className: "grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-start",
                        children: [(0, t.jsxs)(s.motion.div, { ...N,
                            className: "lg:sticky lg:top-32 space-y-4 sm:space-y-6",
                            children: [(0, t.jsx)("p", {
                                className: "text-[10px] sm:text-[11px] font-space tracking-[0.3em] uppercase text-[var(--brand-earth)]",
                                children: "Panchakarma"
                            }), (0, t.jsxs)("h2", {
                                className: "font-cormorant text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight",
                                children: ["The five sacred", (0, t.jsx)("br", {}), (0, t.jsx)("span", {
                                    className: "font-gallient italic text-[var(--brand-forest)]",
                                    children: "purification"
                                }), " ", "rituals"]
                            }), (0, t.jsx)("p", {
                                className: "text-[var(--text-secondary)] font-light leading-relaxed text-sm sm:text-base",
                                children: "Panchakarma is the cornerstone of Ayurvedic detoxification — a series of five therapeutic procedures designed to eliminate deep seated toxins, restore metabolic balance, and rejuvenate the body at the cellular level."
                            }), (0, t.jsx)("p", {
                                className: "text-[var(--text-secondary)] font-light leading-relaxed text-xs sm:text-sm",
                                children: "Each Panchakarma treatment at Ayursreya Wellness is administered under the direct supervision of our B.A.M.S physician, using authentic herbal formulations prepared in-house."
                            })]
                        }), (0, t.jsx)("div", {
                            className: "space-y-4 sm:space-y-5",
                            children: y.panchakarma.map((e, a) => {
                                let i = M === e.id;
                                        ...
                                        children: [(0, t.jsxs)("div", {
                                            ...
                                            children: [(0, t.jsxs)("div", {
                                                ...
                                                children: [(0, t.jsx)("span", {
                                                    className: "w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[var(--brand-forest)]/5 flex items-center justify-center text-xs font-space font-medium text-[var(--brand-forest)] shrink-0",
                                                    children: String(a + 1).padStart(2, "0")
                                                }), (0, t.jsx)("h3", {
                                                    className: "font-cormorant text-lg sm:text-xl md:text-2xl",
                                                    children: e.name
                                                })]
                                            }), (0, t.jsx)("div", {
                                                className: "flex items-center gap-3 sm:gap-4 mt-3 ml-9 sm:ml-11",
                                                children: (0, t.jsxs)("span", {
                                                    className: "flex items-center gap-1.5 text-xs text-[var(--brand-earth)]",
                                                    children: [(0, t.jsx)(o.Clock, {
                                                        className: "w-3 h-3 sm:w-3.5 sm:h-3.5"
                                                    }), e.duration]
                                                })
                                            }), i && (0, t.jsxs)(s.motion.div, {
                                                initial: {
                                                    opacity: 0,
                                                    height: 0
                                                },
                                                ...
                                                }), e.benefits && (0, t.jsxs)("div", {
                                                    className: "space-y-1.5",
                                                    children: [(0, t.jsx)("p", {
                                                        className: "text-[10px] font-space tracking-wider uppercase text-[var(--brand-earth)]",
                                                        children: "Benefits"
                                                    }), e.benefits.map((e, a) => (0, t.jsxs)("div", {
                                                        className: "flex items-start gap-2",
                                                        children: [(0, t.jsx)(b, {
                                                            className: "w-3 h-3 text-[var(--brand-forest)] mt-0.5 shrink-0"
                                                        }), (0, t.jsx)("span", {
                                                            className: "text-xs text-[var(--text-secondary)]",
                                                            children: e
                                                        })]
                                                    }, a))]
                                                }), e.preparation && (0, t.jsxs)("p", {
                                                    className: "text-xs text-[var(--text-secondary)]",
                                                    children: [(0, t.jsx)("span", {
                                                ...
                                                children: [i ? "Show Less" : "Learn More", (0, t.jsx)(v.ChevronDown, {
                                                    className: `w-3 h-3 transition-transform ${i?"rotate-180":""}`
                                                })]
                                            })]
                                        }), (0, t.jsxs)("div", {
                                            className: "text-right shrink-0",
                                            children: [(0, t.jsxs)("span", {
                                                className: "font-gallient text-xl sm:text-2xl md:text-3xl text-[var(--brand-forest)]",
                ...
                className: "py-16 sm:py-20 md:py-24 bg-[var(--brand-forest)] text-white",
                children: (0, t.jsxs)("div", {
                    className: "container mx-auto px-4 sm:px-6 md:px-12 max-w-6xl",
                    children: [(0, t.jsxs)(s.motion.div, { ...N,
                        className: "mb-12 sm:mb-16",
                        children: [(0, t.jsx)("p", {
                            className: "text-[10px] sm:text-[11px] font-space tracking-[0.3em] uppercase text-[var(--brand-sand)] mb-4",
                            children: "Ayurveda Therapies"
                        }), (0, t.jsxs)("h2", {
                            className: "font-cormorant text-2xl sm:text-3xl md:text-4xl lg:text-5xl max-w-2xl",
                            children: ["Therapeutic", " ", (0, t.jsx)("span", {
                                className: "font-gallient italic text-[var(--brand-sand)]",
                                children: "healing"
                            }), " ", "sessions"]
                        })]
                        ...
                        children: y.therapies.map((e, a) => {
                            ...
                            return (0, t.jsx)(s.motion.div, {
                                ...
                                children: (0, t.jsxs)("div", {
                                    ...
                                    children: [(0, t.jsx)("h3", {
                                        className: "font-cormorant text-base sm:text-lg md:text-xl mb-1",
                                        children: e.name
                                    }), e.description && (0, t.jsx)("p", {
                                        className: "text-[10px] sm:text-xs text-white/50 font-light mb-3 sm:mb-4",
                                        children: e.description
                                    }), i && e.fullDescription && (0, t.jsxs)(s.motion.div, {
                                        initial: {
                                            opacity: 0,
                                            height: 0
                                        },
                                        ...
                                        children: [(0, t.jsx)("p", {
                                            ...
                                            children: e.fullDescription
                                        }), e.benefits && (0, t.jsx)("div", {
                                            className: "space-y-1",
                                            children: e.benefits.map((e, a) => (0, t.jsxs)("div", {
                                                className: "flex items-start gap-2",
                                                children: [(0, t.jsx)(b, {
                                                    className: "w-3 h-3 text-[var(--brand-sand)] mt-0.5 shrink-0"
                                                }), (0, t.jsx)("span", {
                                                    className: "text-[10px] text-white/60",
                                                    children: e
                                                })]
                                            }, a))
                                        }), e.duration && (0, t.jsxs)("p", {
                                    ...
                                    }), e.fullDescription && (0, t.jsxs)("button", {
                                        ...
                                        className: "flex items-center justify-between pt-3 border-t border-white/8 mt-auto",
                                        children: [(0, t.jsxs)("span", {
                                            className: "font-gallient text-lg sm:text-xl text-[var(--brand-sand)]",
                                            children: ["₹", e.price.toLocaleString("en-IN")]
                                        }), (0, t.jsx)("button", {
                                            onClick: () => D(`th-${e.id}`),
                ...
                children: (0, t.jsxs)("div", {
                    ...
                    children: [(0, t.jsxs)(s.motion.div, { ...N,
                        ...
                        children: [(0, t.jsx)("p", {
                            className: "text-[10px] sm:text-[11px] font-space tracking-[0.3em] uppercase text-[var(--brand-earth)] mb-4",
                            children: "Conditions We Treat"
                        }), (0, t.jsxs)("h2", {
                            className: "font-cormorant text-2xl sm:text-3xl md:text-4xl lg:text-5xl max-w-2xl mx-auto",
                            children: ["Holistic solutions for", " ", (0, t.jsx)("span", {
                                className: "font-gallient italic text-[var(--brand-forest)]",
                                children: "modern"
                            }), " ", "ailments"]
                        })]
                        ...
                        children: y.conditions.map((e, a) => {
                            let i = A[e.icon] || f.Leaf;
                            return (0, t.jsxs)(s.motion.div, {
                                ...
                                children: [(0, t.jsx)("div", {
                                    className: "w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-[var(--brand-forest)]/5 flex items-center justify-center mb-4 sm:mb-5 group-hover:bg-[var(--brand-forest)]/10 transition-colors duration-500",
                                    children: (0, t.jsx)(i, {
                                        className: "w-4 h-4 sm:w-5 sm:h-5 text-[var(--brand-forest)]",
                                        strokeWidth: 1.5
                                    })
                                }), (0, t.jsx)("h3", {
                                    className: "font-cormorant text-base sm:text-lg md:text-xl mb-2",
                                    children: e.title
                                }), (0, t.jsx)("p", {
                                    className: "text-xs sm:text-sm text-[var(--text-secondary)] font-light leading-relaxed",
                                    children: e.description
                                })]
                            }, e.title)
                        })
                ...
                className: "py-16 sm:py-20 md:py-24 bg-[var(--bg-tertiary)]",
                children: (0, t.jsxs)("div", {
                    className: "container mx-auto px-4 sm:px-6 md:px-12 max-w-6xl",
                    children: [(0, t.jsxs)(s.motion.div, { ...N,
                        className: "mb-12 sm:mb-16",
                        children: [(0, t.jsx)("p", {
                            ...
                            className: "font-cormorant text-2xl sm:text-3xl md:text-4xl lg:text-5xl max-w-2xl",
                            children: ["Specialized", " ", (0, t.jsx)("span", {
                                className: "font-gallient italic text-[var(--brand-forest)]",
                                children: "clinical"
                            }), " ", "programs"]
                        })]
                        ...
                        children: y.advancedCare.map((e, a) => (0, t.jsxs)(s.motion.div, {
                            initial: {
                                opacity: 0,
                                y: 30
                            },
                            ...
                            children: [(0, t.jsxs)("div", {
                                ...
                                children: [(0, t.jsx)("h3", {
                                    className: "font-cormorant text-lg sm:text-xl md:text-2xl mb-2",
                                    children: e.title
                                }), (0, t.jsx)("p", {
                                    className: "text-xs sm:text-sm text-[var(--text-secondary)] font-light mb-4 sm:mb-5",
                                    children: e.subtitle
                                }), (0, t.jsx)("div", {
                                    className: "flex flex-wrap gap-2",
                                    children: e.features.map(e => (0, t.jsx)("span", {
                ...
                children: (0, t.jsx)("div", {
                    className: "container mx-auto px-4 sm:px-6 md:px-12 max-w-4xl text-center",
                    children: (0, t.jsxs)(s.motion.div, { ...N,
                        className: "space-y-6 sm:space-y-8",
                        children: [(0, t.jsx)("p", {
                            className: "text-[10px] sm:text-[11px] font-space tracking-[0.3em] uppercase text-[var(--brand-earth)]",
                            children: "Start Healing Today"
                        }), (0, t.jsxs)("h2", {
                            className: "font-cormorant text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl leading-tight px-4",
                            children: ["Every journey begins with a", " ", (0, t.jsx)("span", {
                                className: "font-gallient italic text-[var(--brand-forest)]",
                                children: "single step"
                            })]
                        }), (0, t.jsx)("p", {
                            className: "text-[var(--text-secondary)] font-light max-w-lg mx-auto text-sm sm:text-base px-4",
                            children: "Consult with our Ayurvedic physician to find the treatment plan that's right for your unique constitution."
                        }), (0, t.jsxs)("div", {
                            ...
                            children: [(0, t.jsxs)("button", {
                                ...
                                children: ["Book a Session", (0, t.jsx)(n.ArrowRight, {
